    ...
    (b.prototype = {
      ...
      init: function() {
        ...
        if (
          ...
          switch ((void 0 === this.options.value || null === this.options.value
    ...
    (b.prototype = {
      ...
      fillHour: function() {
        var a,
          ...
          e = (-1 !== this.options.template.indexOf('H'),
            ...
            : (this.$ampm &&
                (d.hour =
                  12 === d.hour
                    ...
                    : 'am' === this.$ampm.val() ? d.hour : d.hour + 12),
              (c = moment([
                d.year,
                d.month,
                d.day,
    ...
    e.prototype = {
      ...
      _process_options: function(b) {
        ...
        var c = (this.o = a.extend({}, this._o)),
          d = c.language;
        switch ((k[d] || ((d = d.split('-')[0]), k[d] || (d = i.language)),
        (c.language = d),
        c.startView)) {
          case 2:
          case 'decade':
